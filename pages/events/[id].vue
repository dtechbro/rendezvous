...
<template>
  <div>
    <div class="max-w-7xl mx-auto flex flex-col gap-4 my-5">
    <Navbar />
    ...
    <div>
      ...
      <div v-else-if="event" class="p-4">
        <img :src="event.imageUrl" class="w-full h-[350px] object-cover rounded-lg mb-4" />


        <div class="flex flex-col md:flex-row gap-10 items-start px-6 py-30 max-w-7xl mx-auto">
          <!-- event details on the left  -->
          <div class="md:w-[70%] flex flex-col items-start gap-4">
            ...
            <div>
              ...
              <div class="grid grid-cols-2 gap-4 mt-2">
                <span>
                  <h2 class="text-xl">Single</h2>
                  <p class="text-[#9B51E0] text-lg font-medium">NGN {{ event.price }}</p>
                </span>

                <span>
                  <h2 class="text-lg">Pairing</h2>
                  <p class="text-[#9B51E0] text-lg font-medium">NGN {{ event.price }}</p>
                </span>
              </div>
            </div>

            <nuxt-link to="#" class="px-6 py-2 mt-6 bg-[#783EAD] text-white rounded-lg block">Buy Now</nuxt-link>
          ...
          <div class="md:w-[30%]">
            <div>
              ...
              <div class="flex gap-4">
                <nuxt-link to="" class="bg-[#783EAD] text-white p-3 rounded-full">
